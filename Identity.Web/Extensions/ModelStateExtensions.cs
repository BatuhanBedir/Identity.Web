...
public static class ModelStateExtensions
{
    ...
    public static void AddModelErrorList(this ModelStateDictionary modelStateDictionary,
        IEnumerable<IdentityError> errors)
    {
        errors.ToList().ForEach(x => { modelStateDictionary.AddModelError(string.Empty, x.Description); });
    }
}